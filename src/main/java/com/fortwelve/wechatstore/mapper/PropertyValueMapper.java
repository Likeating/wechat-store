...
public interface PropertyValueMapper {
    ...
    @Insert("insert into category (value_name,picture_id) values (#{value_name},#{picture_id})")
    ...
    public int deletePropertyValueById(java.math.BigInteger id);

    @Select("select * from property_value where value_id = #{id}")
    public PropertyValue getPropertyValueById(java.math.BigInteger id);
